...
public class ScatterPlot {
	...
	public ScatterPlot(String fileName, String titleNotFinal ,final ArrayList<ArrayList<Double>> sizes, final ArrayList<ArrayList<Double>> colors)
	{
		final String title = titleNotFinal;
		...
		JPanel pane = new JPanel()
		{
			...
			protected void paintComponent(Graphics g)
			{
				...
				String colorRange = "Color Range: " + String.valueOf(minColor) + " to " + String.valueOf(maxColor);
				g.drawString(colorRange, w/3, h - offset/2);
				g.drawString(title, w/3, offset/2);
